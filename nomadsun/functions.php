...
function nomadsun_scripts() {
	...
	wp_enqueue_style ( 'nomadsun-custom', get_template_directory_uri() . 
	'/css/custom.css');

	wp_enqueue_style ( 'nomadsun-barba', get_template_directory_uri() . 
	'/js/barba.js');

	wp_enqueue_style ( 'nomadsun-main', get_template_directory_uri() . 
